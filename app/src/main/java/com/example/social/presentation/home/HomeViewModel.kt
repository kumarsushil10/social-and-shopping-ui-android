...
class HomeViewModel : ViewModel() {
    ...
    fun getStatus(context: Context) {
        ...
        val quickTipsListType =
            Types.newParameterizedType(List::class.java, QuickTipsModel::class.java)
        ...
        val connectionListType =
            Types.newParameterizedType(List::class.java, ConnectionModel::class.java)
        val connectionAdapter: JsonAdapter<List<ConnectionModel>> =
            moshi.adapter(connectionListType)
