...
class StatusAdapter : ListAdapter<StatusModel, RecyclerView.ViewHolder>(StatusModel.diffCallback) {
    ...
    class StatusViewHolder(private val binding: HomeStatusLayoutBinding) :
        ...
        fun bind(status: StatusModel) {
            ...
            if (status.isLive) {
                ...
                binding.chip.chipBackgroundColor =
                    ColorStateList.valueOf(status.cornerColor.toColorInt())
            }
        }
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        binding =
            HomeStatusLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
